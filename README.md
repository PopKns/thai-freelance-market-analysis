...
โค้ดในโปรเจกต์นี้เผยแพร่ภายใต้ [MIT License](./LICENSE) — ส่วน *ข้อมูล* เผยแพร่เฉพาะแบบ
aggregate/anonymized ตามหัวข้อ Ethics & Compliance ข้างต้น (ไม่ใช่ของที่อยู่ภายใต้ MIT)
